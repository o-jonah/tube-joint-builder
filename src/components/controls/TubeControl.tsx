        ...
        <>
          ...
          <Tabs defaultValue="dimensions" className="w-full">
            ...
            <TabsContent value="dimensions" className="space-y-4 pt-4">
              type UpdateTubeFn = (id: string, updates: Partial<TubeParameters>) => void;
              type AddTubeFn = (type: 'rectangular' | 'square') => void;
              type DeleteTubeFn = (id: string) => void;

              interface TubeControlsProps {
                selectedTube?: TubeParameters;
                onUpdateTube: UpdateTubeFn;
                onAddTube: AddTubeFn;
                onDeleteTube: DeleteTubeFn;
              }

              export const TubeControls: React.FC<TubeControlsProps> = ({
                selectedTube,
                onUpdateTube,
                onAddTube,
                onDeleteTube,
              }: TubeControlsProps) => {
                const handleNumberChange = (field: keyof TubeParameters, value: string): void => {
                  if (!selectedTube) return;
                  const numValue = parseFloat(value);
                  if (!isNaN(numValue) && numValue >= 0) {
                    onUpdateTube(selectedTube.id, { [field]: numValue });
                          ...
                          <TabsContent value="dimensions" className="space-y-4 pt-4">
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => handleNumberChange('width', e.target.value)}
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => handleNumberChange('height', e.target.value)}
                                className="bg-input border-border text-foreground"
                              />
                            </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => handleNumberChange('thickness', e.target.value)}
                                className="bg-input border-border text-foreground"
                              />
                            </div>
                            ...
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => handleNumberChange('length', e.target.value)}
                                className="bg-input border-border text-foreground"
                              />
                            </div>
                          </TabsContent>
